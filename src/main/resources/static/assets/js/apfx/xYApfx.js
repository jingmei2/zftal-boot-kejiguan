jQuery(function($) {
	...
	var xyId = $("#instituteId").val();
	getChartData(daySelectedHere,xyId);
...
var chartData = {};
//获取月份数据,初始化图表，初始化表格
function getChartData(lastDates,xyId){
	$.get(_path+"/mAp/selectApCountList?daySelected="+lastDates+"&xyId="+xyId,function(result,status){
...
//跳转到学院ap分析页面
function toBjApCountPage(){
	window.location.href=_path+"/apfx/bJApfx";
}
