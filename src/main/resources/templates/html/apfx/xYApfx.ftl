...
s                  </select>
		      ...
		      <div class="sssj-xssj">
			      <div class="sssj-xssj-yhTitle">
		             <div class="sssj-xssj-subTitle">关键指标详解</div>
			             <div id="xxap" class="sssj-xssj-type">学院AP</div>
				     <div id="" style="clear:both;"></div>
			      </div>
			      <div class="sssj-xssj-data" onclick="toBjApCountPage();">
	...
	<script type="text/javascript" src="${request.contextPath}/assets/js/apfx/xYApfx.js?ver=${versionUtil()}"></script>
